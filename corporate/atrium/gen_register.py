...
<main id="main">
  ...
  <nav class="ho-index wrap wrap-n" aria-label="Sections of this document">
    <a href="#brand">Brand</a>
    <a href="#colour">Colour</a>
    <a href="#type">Typography</a>
    <a href="#ia">Information architecture</a>
    <a href="#components">Components</a>
    <a href="#rules">Motion &amp; content</a>
    <a href="#roadmap">Roadmap</a>
    <a href="#asks">What we need</a>
  </nav>
...
{mods}
  ...
  <section class="band wrap wrap-n" id="roadmap">
    <div class="band-head">
      ...
      <p class="rv" data-d="2">The order is what matters here, not a calendar. Phase&nbsp;0 gates everything, Phases&nbsp;1 and&nbsp;2 run in parallel, and only the items marked as Wiseman&rsquo;s can hold the sequence&nbsp;up.</p>
    </div>

    <ol class="ho-phases rv">
      <li>
        <p class="ho-ph-n tnum">Phase 0</p>
        <div>
          ...
          <p class="ho-them"><b>Wiseman provides</b> <a class="ho-ref" href="index.html#h-origins">a founding year in writing</a> &middot; a decision on <a class="ho-ref" href="index.html#h-origins">&ldquo;over 45&nbsp;years&rdquo;</a> and <a class="ho-ref" href="buildings.html">&ldquo;100+&nbsp;communities&rdquo;</a> &middot; <a class="ho-ref" href="#site-map">the responsible broker entity and DRE&nbsp;number</a> &middot; <a class="ho-ref" href="company.html#client-gaps">leadership names and bios</a> &middot; <a class="ho-ref" href="company.html#client-gaps">a values statement</a>.</p>
        </div>
      </li>
      <li>
        <p class="ho-ph-n tnum">Phase 1</p>
        <div>
          ...
          <p class="ho-them"><b>Wiseman provides</b> <a class="ho-ref" href="#brand">vector logo files</a> &middot; <a class="ho-ref" href="#site-map">which Instagram handle is canonical</a> &middot; <a class="ho-ref" href="privacy.html">counsel review of the legal drafts</a> &middot; <a class="ho-ref" href="contact.html">corrected address of record</a> on CSLB, BBB and Archinect.</p>
        </div>
      </li>
      <li>
        <p class="ho-ph-n tnum">Phase 2 &middot; parallel with Phase&nbsp;1</p>
        <div>
          ...
          <p class="ho-them"><b>Wiseman provides</b> <a class="ho-ref" href="search.html">API credentials and the account manager</a> &middot; <a class="ho-ref" href="buildings.html">confirmation of canonical property IDs</a> &middot; a fix for <a class="ho-ref" href="buildings/motor-tides.html">the Motor Tides listing URL</a>, which currently reads <code>motor-tabor-by-wiseman</code>.</p>
        </div>
      </li>
      <li>
        <p class="ho-ph-n tnum">Phase 3</p>
        <div>
          <h3>Motor Tides</h3>
          ...
          <p class="ho-them"><b>Wiseman provides</b> <a class="ho-ref" href="buildings/motor-tides.html#gal-h">written rights confirmation for the Vimeo tour&nbsp;library</a> &middot; <a class="ho-ref" href="buildings/motor-tides.html#plans-h">floor plan files and a signed-off amenity&nbsp;list</a> &middot; <a class="ho-ref" href="buildings/motor-tides.html#office-h">leasing phone, hours and tour&nbsp;method</a> &middot; a decision on a standalone domain.</p>
        </div>
      </li>
      <li>
        <p class="ho-ph-n tnum">Phase 4 &middot; then rolling</p>
        <div>
          ...
          <p class="ho-them"><b>Wiseman provides</b> <a class="ho-ref" href="buildings.html">per-building photography</a> or a decision to shoot &middot; <a class="ho-ref" href="buildings/motor-midway.html">any building-specific copy worth&nbsp;keeping</a> &middot; <a class="ho-ref" href="buildings/motor-tides.html#office-h">on-site manager names and hours</a>.</p>
        </div>
      </li>
      <li>
        <p class="ho-ph-n tnum">Phase 5</p>
        <div>
          ...
          <p class="ho-them"><b>Wiseman provides</b> DNS access &middot; <a class="ho-ref" href="sitemap.html">final sign-off, page by page</a> &middot; who owns the site internally after launch.</p>
        </div>
      </li>
    </ol>
  </section>
  ...
  <section class="promise" id="asks" data-hd="light">
    <div class="band wrap wrap-n">
      <div class="band-head">
        ...
        <p class="rv" data-d="2">Everything else is ours. Each one links to the place on the site that shows what it&nbsp;affects.</p>
      </div>
      <ul class="ho-asks rv">
        <li><span class="ho-tag ho-tag-block">Blocks Phase 0</span><h4><a class="ho-ref" href="index.html#h-origins">A founding year, in writing</a></h4><p>LinkedIn says 1980, the contractor licence carries 1982, the Archinect profile says 1985, the Better Business Bureau has 1987. No page states a year until one is chosen.</p></li>
        <li><span class="ho-tag ho-tag-block">Blocks Phase 0</span><h4><a class="ho-ref" href="index.html#h-origins">A decision on &ldquo;45 years&rdquo; and &ldquo;100+ communities&rdquo;</a></h4><p>Both are on the current homepage; neither is supported by any public source we could find, and the live feed lists {total} buildings.</p></li>
        <li><span class="ho-tag ho-tag-block">Blocks Phase 0</span><h4><a class="ho-ref" href="#site-map">Responsible broker entity and DRE number</a></h4><p>Every principal&rsquo;s licence reads as expired and no company record exists. The footer needs a correct one before launch.</p></li>
        <li><span class="ho-tag ho-tag-block">Blocks Phase 0</span><h4><a class="ho-ref" href="company.html#client-gaps">Leadership, values and history in the company&rsquo;s words</a></h4><p>The only name any public source supports is founder Isaac Cohanzad.</p></li>
        <li><span class="ho-tag ho-tag-soon">Phase 2</span><h4><a class="ho-ref" href="search.html">RentCafe / Yardi API access</a></h4><p>The single biggest upgrade available: with it, the site maintains itself.</p></li>
        <li><span class="ho-tag ho-tag-soon">Phase 1</span><h4><a class="ho-ref" href="#brand">Vector logo files</a></h4><p>The mark has been rebuilt from a 600px PNG; the original vector will be sharper at every size.</p></li>
        <li><span class="ho-tag ho-tag-soon">Phase 3</span><h4><a class="ho-ref" href="buildings/motor-tides.html#gal-h">Rights confirmation for the video library</a></h4><p>{vimeo} embeddable clips are already owned &mdash; a real asset &mdash; but they carry a third-party watermark.</p></li>
        <li><span class="ho-tag ho-tag-soon">Phase 3</span><h4><a class="ho-ref" href="buildings.html">A photography decision</a></h4><p>The existing library is interiors only. A half-day shoot with a licensed drone operator is the only way to get the actual buildings and streets on screen.</p></li>
        <li><span class="ho-tag ho-tag-later">Phase 1</span><h4><a class="ho-ref" href="#site-map">Canonical social handles</a></h4><p>Two Instagram accounts are live and the site data points at the less-followed one.</p></li>
